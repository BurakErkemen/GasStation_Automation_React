export const siteConfig = {
  ...
  hours:       "7/24 Açık",
  address:     "Hatay / Belen",
  mapIframe:   "", // Google Maps embed URL buraya
  ...
  hero: {
    ...
    description: "Güvenli dolum, hızlı hizmet ve konforlu mola. Canlı akaryakıt fiyatları Firebase üzerinden anlık güncellenir.",
    buttons: {
    ...
    slides: [
      { tag: "Hizmet", n: "01", title: "Opet Kalitesi",  body: "Standartlara uygun, güvenilir akaryakıt ve profesyonel hizmet anlayışıyla yanınızdayız." },
      { tag: "Market", n: "02", title: "Market İmkânı",  body: "Yol üstü ihtiyaçlarınız için pratik alışveriş. Atıştırmalık, içecek ve daha fazlası."    },
      { tag: "Konfor", n: "03", title: "Konforlu Mola",  body: "Temiz ve ferah dinlenme alanıyla yolculuğunuza taze bir başlangıç yapın."                 },
    ],
  },
  ...
  about: {
    ...
    description: "Kahramanlar Belen Akaryakıt olarak Hatay/Belen bölgesinde, Opet çözüm ortağı güvencesiyle hizmet veriyoruz. Her dolumda kalite, her ziyarette memnuniyet.",
    ticks: [
  ...
  // ── Footer ─────────────────────────────────────
  footer: {
    copy:  "© 2025 Kahramanlar Belen Akaryakıt · Tüm hakları saklıdır.",
    links: [
